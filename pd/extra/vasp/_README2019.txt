# Compile vasp with VS2019 and Win32 
#### Written by Michael Sattler OEAW ISF 27.8.2019 
#### Main source: https://github.com/grrrr/vasp
...
3. In this folder open vasp.vcxproj
...
6. Your `vasp.dll`  file should now be located at `<VaspDirectory>\pd-msvc\r`
