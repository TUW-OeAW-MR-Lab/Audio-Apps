...
|     /CurvedLED/Volume | /CurvedLED/Volume _volume_ | get the volume of the Curved-LED section  with _volume_ re dB FS | /CurvedLED/Volume -30 |
|     /CurvedLED/Switch _value_ | - | switch the Curved-LED section off and on with _value_ = { 0, 1}, respectively | /CurvedDoor/Switch 1 |
|     /CurvedDoor/Volume/Set _volume_ | - | set the volume of the Curved-door section with _volume_ re dB FS | /CurvedDoor/Volume/Set -25  |
|     /CurvedDoor/Volume | /CurvedLED/Volume _volume_ | get the volume of the Curved-door section  with _volume_ re dB FS | /CurvedDoor/Volume -25 |
|     /CurvedDoor/Switch _value_ | - | switch the Curved-door section off and on with _value_ = { 0, 1}, respectively | /CurvedDoor/Switch 1 |
|     /SA/Volume/Set _volume_ | - | set the volume of the spatial-audio section with _volume_ re dB FS | /SA/Volume/Set -20  |
|     /SA/Volume | /SA/Volume _volume_ | get the volume of the spatial-audio section  with _volume_ re dB FS | /SA/Volume -20 |
|     /SA/Switch _value_ | - | switch the spatial-audio section off and on with _value_ = { 0, 1}, respectively | /SA/Switch 1 |
|     /CAVEDoor/Volume/Set _volume_ | - | set the volume of the CAVE-door section with _volume_ re dB FS | /CAVEDoor/Volume/Set -15  |
|     /CAVEDoor/Volume | /CAVEDoor/Volume _volume_ | get the volume of the CAVE-door section  with _volume_ re dB FS | /CAVEDoor/Volume -15 |
|     /CAVEDoor/Switch _value_ | - | switch the CAVE-door section off and on with _value_ = { 0, 1}, respectively | /CAVEDoor/Switch 1 |
|     /CAVE/Volume/Set _volume_ | - | set the volume of the CAVE section with _volume_ re dB FS | /CAVE/Volume/Set -10  |
|     /CAVE/Volume | /CAVE/Volume _volume_ | get the volume of the CAVE section  with _volume_ re dB FS | /CAVE/Volume -10 |
|     /CAVE/Switch _value_ | - | switch the CAVE section off and on with _value_ = { 0, 1}, respectively | /CAVE/Switch 1 |